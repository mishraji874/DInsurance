...
contract AzurancePoolTest is Test {
    ...
    function setUp() public {
        ...
        address _pool = factory.createAzuranceContract(
    ...
    // function test_Revert_BuyInsuranceExceedMax() public {
    ...
    // function test_Revert_BuyInsuranceInStaleTime() public {
    //     uint _amount = 100 * 10 ** testERC20.decimals();
    //     vm.startPrank(address(1));
    //     testERC20.approve(address(azurancePool), _amount * 2);
    //     azurancePool.sellInsurance(_amount * 2);
    ...
    // function test_Revert_ChangeStateFromClaimableToMatured() public {
    //     azurancePool.checkUnlockClaim();
    //     azurancePool.unlockMaturity();
    // }

    // function test_Revert_ChangeStateFromMaturedToClaimable() public {
    //     azurancePool.unlockMaturity();
    //     azurancePool.checkUnlockClaim();
    // }

    // Test withdrew on claimable - check seller and buyer token amount
